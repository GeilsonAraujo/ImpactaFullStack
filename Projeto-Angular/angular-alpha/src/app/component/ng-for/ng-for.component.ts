...
// criar nossa propriedades para vincular na view
...
// criar uma nova classe para ser o model domain da estrutura logica
// para adequar o formato necessário ao dataset
class Filme{
  titulo!: string
  direcao!: string
  elenco!: string
